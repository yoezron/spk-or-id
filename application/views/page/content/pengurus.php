        ...
        <div class="row gx-30">
            <div class="col-xxl-8 col-lg-7">
                <div class="th-blog blog-single">
                    <div class="blog-img">
                        <img src="assets/img/blog/pengurus.jpeg" alt="Blog Image">
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            ...
                            <a href="pengurus"><i class="fa-light fa-book"></i>Pengurus SPK</a>
                        </div>
                        <h2 class="blog-title"><?= $content['urus_title']; ?></h2>
                        <p><?= $content['urus_content']; ?></p>
                    </div>

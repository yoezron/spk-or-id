...
<div class="th-hero-wrapper hero-1" id="hero">
    <div class="hero-slider-1 th-carousel" data-fade="true" data-slide-show="1" data-md-slide-show="1" data-dots="true">
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-overlay="title" data-opacity="8" data-bg-src="assets/img/hero/hero_bg_1_1.png"></div>
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s">Mari Bergabung di <span>Serikat Pekerja Kampus</span></span>
                            <h1 class="hero-title text-white" data-ani="slideinleft" data-ani-delay="0.4s">Bersama Perjuangkan Kesejahteraan <span class="text-theme">Pekerja Kampus</span></h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">Perjuangan atas kesejahteraan, perjuangan untuk mendapatkan kebebasan akademik sepenuhnya, perjuangan terhadap kepastian kerja, hingga perjuangan untuk mendapatkan waktu libur yang cukup, hanya akan bisa dilakukan melalui serikat.</p>
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                <a href="register" class="th-btn style3">Bergabung<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 text-lg-end text-center">
                        <div class="hero-img1">
                            <img src="assets/img/hero/hero_thumb_1_1.png" alt="hero">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-overlay="title" data-opacity="8" data-bg-src="assets/img/hero/hero_bg_1_2.png"></div>
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s">Bergabung Bersama <span><?= $total_users - 1; ?> Pekerja Kampus</span></span>
                            <h1 class="hero-title text-white" data-ani="slideinleft" data-ani-delay="0.4s">Sebanyak <?= $total_users - 1; ?> Pekerja Kampus telah Bergabung Bersama <span class="text-theme">SPK</span></h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">Memperjuangkan kesejahteraan memerlukan kekuatan, kekompakan dan solidaritas yang besar antara pekerja kampus. Semakin besar kekuatan kita, semakin signifikan kekuatan perjuangan Serikat Pekerja Kampus.</p>
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                <a href="register" class="th-btn style3">Bergabung<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    ...
                    <div class="col-md-6 text-lg-end text-center">
                        <div class="hero-img1">
                            <img src="assets/img/hero/hero_thumb_1_2.png" alt="hero">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="th-hero-slide">
            <div class="th-hero-bg" data-overlay="title" data-opacity="8" data-bg-src="assets/img/hero/hero_bg_1_3.png"></div>
            <div class="container">
                <div class="row align-items-center justify-content-center">
                    <div class="col-md-6">
                        <div class="hero-style1">
                            <span class="hero-subtitle" data-ani="slideinleft" data-ani-delay="0.1s">Kenali Lebih Dekat <span>Serikat Pekerja Kampus</span></span>
                            <h1 class="hero-title text-white" data-ani="slideinleft" data-ani-delay="0.4s">SPK Merupakan Serikat Pertama di Indonesia yang Mewadahi <span class="text-theme">Perjuangan Pekerja Kampus</span></h1>
                            <p class="hero-text" data-ani="slideinleft" data-ani-delay="0.6s">Serikat Pekerja Kampus bertujuan mewujudkan keadilan sosial dan kesejahteraan melalui perlindungan dan pembelaan hak serta
                                kepentingan bagi pekerja kampus dengan prinsip kesetaraan dan non-diskriminatif. Pekerja kampus adalah setiap orang yang bekerja di sektor pendidikan tinggi, baik itu dosen, tenaga pendidik, staff, outsourcing dan lainnya.</p>
                            <div class="btn-group" data-ani="slideinleft" data-ani-delay="0.8s">
                                <a href="about" class="th-btn style3">Kenali SPK<i class="fas fa-arrow-right ms-2"></i></a>
                            </div>
                        </div>
                    </div>
                    <div class="col-md-6 text-lg-end text-center">
                        <div class="hero-img1">
                            <img src="assets/img/hero/hero_thumb_1_3.png" alt="hero">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-xl-4">
                    <div class="title-area mb-25 mb-lg-0 text-xl-start text-center">
                        <span class="sub-title"><i class="fal fa-book me-2"></i> Serikat Pekerja Kampus</span>
                        <h2 class="sec-title">Kenali Kami Lebih Dekat</h2>
                        <a href="about" class="th-btn">Tentang Kami<i class="fa-regular fa-arrow-right ms-2"></i></a>
                    </div>
                </div>
                <div class="col-xl-8">
                    <div class="row slider-shadow th-carousel category-slider" data-slide-show="4" data-ml-slide-show="3" data-md-slide-show="3" data-sm-slide-show="2" data-arrows="true" data-xl-arrows="true">
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="sejarah">Sejarah</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus </small>
                                    <a href="sejarah" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="manifesto">Manifesto</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus </small>
                                    <a href="manifesto" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="visimisi">Visi dan Misi</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus</small>
                                    <a href="visimisi" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="adart">AD/ART</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus</small>
                                    <a href="adart" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <!--        </div>-->
                        <!--        <div class="category-card_content">-->
                        <!--            <h3 class="category-card_title"><a href="pengurus">Pengurus</a></h3>-->
                        <!--            <small class="category-card_text">Serikat Pekerja Kampus</small>-->
                        <!--            <a href="pengurus" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>-->
                        <!--        </div>-->
                        <!--    </div>-->
                        <!--</div>-->
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="post">Berita</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus</small>
                                    <a href="post" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="contact">Pengaduan</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus</small>
                                    <a href="contact" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-6 col-xl-4">
                            <div class="category-card">
                                ...
                                <div class="category-card_content">
                                    <h3 class="category-card_title"><a href="register">Bergabung</a></h3>
                                    <small class="category-card_text">Serikat Pekerja Kampus</small>
                                    <a href="register" class="th-btn">Selengkapnya<i class="fa-solid fa-arrow-right ms-1"></i></a>
                                </div>
                            </div>
                        </div>
        ...
        <div class="row align-items-center">
            <div class="col-xl-6">
                <div class="img-box1 mb-40 mb-xl-0">
                    ...
                    <div class="about-grid" data-bg-src="assets/img/normal/about_1_3.png">
                        <h3 class="about-grid_year"><span class="counter-number"><?= $total_users - 1; ?></span><span class="text-theme">+</span></h3>
                        <p class="about-grid_text">Anggota Aktif</p>
                    </div>
                    <div class="img2">
            ...
            <div class="col-xl-6">
                <div class="title-area mb-30">
                    <span class="sub-title"><i class="fal fa-book me-2"></i> Tentang Serikat Pekerja Kampus</span>
                    <h2 class="sec-title">Selamat datang para Pekerja Kampus!</h2>
                </div>
                <p class="mt-n2 mb-25">Serikat Pekerja Kampus (SPK) adalah wadah yang didirikan untuk memperjuangkan hak dan kesejahteraan pekerja di perguruan tinggi. Berawal dari kesadaran akan tantangan dan diskriminasi yang dihadapi, SPK berkomitmen menjadi suara bagi dosen, tenaga kependidikan, dan staf lainnya. Kami bertekad menghadirkan perubahan nyata untuk meningkatkan kualitas hidup dan profesionalisme anggota. </p>
                <p class="mb-30">Sejak awal, SPK menjadi pelopor advokasi hak pekerja di pendidikan tinggi. Kami meyakini bahwa kesejahteraan dan kebebasan akademik adalah hak fundamental. Banyak pekerja kampus mengalami ketidakpastian kerja dan imbalan yang tidak sebanding dengan beban kerja, menjadikan keberadaan serikat pekerja sangat penting untuk dukungan dan perlindungan yang diperlukan.</p>
                <div class="row align-items-center">
                    ...
                    <div class="col-md-7">
                        <div class="checklist">
                            <ul>
                                <li>Beranggotakan <?= $total_users - 1; ?>+ Pekerja Kampus</li>
                                <li>Memiliki Perwakilan di Setiap Provinsi</li>
                                <li>Telah mengadvokasi banyak Pekerja Kampus</li>
                            </ul>
                        </div>
                    </div>
                </div>
...
<section class="space" data-bg-src="assets/img/bg/course_bg_1.png" id="blog-sec">
    <div class="container">
        <div class="mb-35 text-center text-md-start">
            <div class="row align-items-center justify-content-between">
                <div class="col-md-8">
                    <div class="title-area mb-md-0">
                        <span class="sub-title"><i class="fal fa-book me-2"></i>Berita Serikat Pekerja Kampus</span>
                        <h2 class="sec-title">Publikasi Terkini SPK</h2>
                    </div>
                </div>
                <div class="col-md-auto">
                    <a href="<?= base_url('post'); ?>" class="th-btn">Lihat Semua Postingan<i class="fa-solid fa-arrow-right ms-2"></i></a>
                </div>
            </div>
        </div>
        <div class="row slider-shadow th-carousel blog-slider" data-slide-show="3" data-ml-slide-show="2" data-lg-slide-show="2" data-md-slide-show="1" data-sm-slide-show="1" data-arrows="true">
            <?php
            ...
            if (!empty($all_posts)) :
                foreach ($all_posts as $post) : ?>
                    <div class="col-md-6 col-lg-4 mb-30">
                        <div class="th-blog blog-single has-post-thumbnail shadow">
                            <div class="blog-img">
                                <a href="<?= base_url('post/view/' . $post['slug']); ?>">
                                    <img src="<?= base_url('assets/img/posting/' . $post['gambar']); ?>" style="width: 100%; height: 250px; object-fit: cover;">
                                </a>
                            </div>
                            <div class="blog-content">
                                ...
                                <h3 class="blog-title">
                                    <a href="<?= base_url('post/view/' . $post['slug']); ?>"><?= substr($post['judul_tulisan'], 0, 75) . (strlen($post['judul_tulisan']) > 75 ? '...' : ''); ?></a>
                                </h3>
...
Cta Area  
==============================-->
<div class="cta-area-1" data-bg-src="<?= base_url('assets'); ?>/img/bg/cta-bg1.png">
    <div class="container">
        <div class="row align-items-center justify-content-between">
            <div class="col-lg-8">
                <div class="cta-wrap title-area mb-0">
                    <div class="cta-icon">
                        <img src="<?= base_url('assets'); ?>/img/normal/cta-icon1.png" alt="icon">
                    </div>
                    <div class="cta-content">
                        <h2 class="cta-title sec-title">Hubungi Kami</h2>
                        <p class="cta-text">Mari Berdiskusi dan Sampaikan Kritik Maupun Saran</p>
                    </div>
                    <a href="contact" class="th-btn style8">Hubungi Kami Sekarang<i class="fas fa-arrow-right ms-1"></i></a>
                </div>
            </div>
        </div>
    </div>
    <div class="cta-img-1" data-overlay="title" data-opacity="8">
        <img src="<?= base_url('assets'); ?>/img/normal/cta_1_1.png" alt="Image">
        <a href="https://www.youtube.com/watch?v=3P1XK_R6xl4" class="play-btn style2 popup-video"><i class="fa-sharp fa-solid fa-play"></i></a>
    </div>
</div>
<!--==============================
Why choose us Area  
            ...
            <div class="col-xl-6">
                <div class="wcu-img-1">
                    ...
                    <div class="student-count jump-reverse">
                        <h5 class="title"><span class="text-theme"><span class="counter-number"><?= $total_users - 1; ?></span>+</span> Anggota Aktif</h5>
                        <img src="assets/img/normal/member.png" alt="img">
                    </div>
                    <div class="text-end">
                        <a class="th-btn mt-30" href="register">Mari Bergabung<i class="far fa-arrow-right ms-1"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6">
                <div class="wcu-wrap1">
                    <div class="title-area mb-25">
                        <span class="sub-title"><i class="fal fa-book me-2"></i> Kenapa SPK</span>
                        <h2 class="sec-title">Ratusan Pekerja Kampus Berserikat di Serikat Pekerja Kampus</h2>
                        <p class="sec-text mt-20">Kemerdekaan bagi pekerja kampus tidak akan jatuh begitu saja dari langit. Ini adalah hasil dari perjuangan dan kesadaran kolektif. Dengan berserikat, pekerja kampus dapat meningkatkan posisi tawar dan menghapus diskriminasi serta ketidakadilan dalam lingkungan kerja mereka. Serikat Pekerja Kampus bertekad untuk memperjuangkan kesejahteraan dan keadilan bagi semua pekerja kampus di Indonesia. Kami mengundang semua pekerja kampus untuk bergabung dalam perjuangan ini. </p>
                    </div>
                    <div class="row gy-4">
                        <div class="col-md-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Alat Perjuangan</h3>
                                    <p class="wcu-box_text">Perjuangan atas kesejahteraan,
                                        perjuangan untuk mendapatkan kebebasan akademik sepenuhnya, perjuangan terhadap kepastian kerja, hingga perjuangan untuk mendapatkan kesejahteraan.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Wadah Persatuan</h3>
                                    <p class="wcu-box_text">Kita kuat karena bersatu.
                                        Dengan bersatu pulalah, posisi tawar kita jauh lebih kuat terhadap kekuasaan dan kebijakannya yang menindas.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Tempat Memupuk Solidaritas</h3>
                                    <p class="wcu-box_text">Seharusnya kita tidak lagi dibatasi oleh sekat-sekat kampus.
                                        Satu kampus milik bersama, tanpa batas tanpa penindasan.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="wcu-box">
                                ...
                                <div class="wcu-box_details">
                                    <h3 class="box-title">Berdaulat</h3>
                                    <p class="wcu-box_text">Serikat Pekerja Kampus merupakan wadah pekerja yang berdaulat.</p>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="row justify-content-between">
            <div class="col-sm-6 col-xl-3 counter-card-wrap">
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number"><?= $total_users - 1; ?></span><span class="fw-normal">+</span></h2>
                    <p class="counter-card_text"><strong>Anggota</strong> Aktif</p>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3 counter-card-wrap">
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">35</span><span class="fw-normal">+</span></h2>
                    <p class="counter-card_text"><strong>Perwakilan</strong> Wilayah</p>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3 counter-card-wrap">
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">500</span><span class="fw-normal">+</span></h2>
                    <p class="counter-card_text"><strong>Kampus</strong> Asal</p>
                </div>
            </div>
            <div class="col-sm-6 col-xl-3 counter-card-wrap">
                <div class="counter-card">
                    <h2 class="counter-card_number"><span class="counter-number">100</span><span class="fw-normal">+</span></h2>
                    <p class="counter-card_text"><strong>Kota</strong> Asal Anggota</p>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container text-center">
        <div class="cta-wrap2">
            <div class="title-area text-center mb-35">
                <span class="sub-title"><i class="fal fa-book me-2"></i>Apakah anda siap berjuang bersama kami?</span>
                <h2 class="sec-title text-white">Serikat Pekerja Kampus merupakan <span class="text-theme2">Serikat Pertama di Indonesia</span> yang Mewadahi Pekerja Kampus <br> <span class="fw-normal">di Seluruh Wilayah Indonesia</span></h2>
                <p class="cta-text">Mari berjuang bersama kami dan menggalang kekuatan untuk menghasilkan perubahan kesejahteraan para pekerja kampus menjadi lebih baik.</p>
            </div>
            <div class="btn-group justify-content-center">
                <a href="register" class="th-btn style3">Bergabung bersama kami<i class="fas fa-arrow-right ms-2"></i></a>
                <a href="auth" class="th-btn style2">Masuk<i class="fas fa-arrow-right ms-2"></i></a>
            </div>
        </div>
    </div>
</section>
...
<!--                <div class="title-area mb-30">-->
<!--                    <span class="sub-title"><i class="fal fa-book me-2"></i> Pengurus Serikat Pekerja Kampus</span>-->
<!--                    <h2 class="sec-title">Kenali Para Pengurus Serikat Pekerja Kampus</h2>-->
<!--                    <p class="sec-text mt-20">Berasal dari berbagai latar belakang kampus, status kepegawaian dan wilayah se Indonesia, pengurus Serikat Pekerja Kampus berjuang menjalankan roda serikat terus berkembang.</p>-->
<!--                    <p class="sec-text">Pengurus Serikat Pekerja Kampus berkomitmen untuk mengembangkan dan memperjuangkan isu-isu pekerja kampus di seluruh Indonesia.</p>-->
<!--                </div>-->
<!--                <div class="btn-group mt-30">-->
                    <!--<a href="pengurus" class="th-btn">Kenali Pengurus Serikat<i class="fas fa-arrow-right ms-2"></i></a>-->
<!--                    <a href="contact" class="th-btn style7">Hubungi Kami<i class="fas fa-arrow-right ms-2"></i></a>-->
<!--                </div>-->
<!--            </div>-->
...
<!--                            <h3 class="team-title"><a href="team-details.html">Dhiya Al-Uyun</a></h3>-->
<!--                            <span class="team-desig">Ketua SPK</span>-->
<!--                        </div>-->
<!--                        <div class="team-info">-->
<!--                            <span><i class="fal fa-file-check"></i><small>Universitas Brawijaya</small></span>-->
<!--                            <span><i class="fa-light fa-users"></i>Ketua</span>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        </div>-->
<!--                        <div class="team-content">-->
<!--                            <h3 class="team-title"><a href="team-details.html">Rr. Diah Asih P.</a></h3>-->
<!--                            <span class="team-desig">Bendahara</span>-->
<!--                        </div>-->
<!--                        <div class="team-info">-->
<!--                            <span><i class="fal fa-file-check"></i>ITB</span>-->
<!--                            <span><i class="fa-light fa-users"></i>Bendahara</span>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
...
<!--                        </div>-->
<!--                        <div class="team-content">-->
<!--                            <h3 class="team-title"><a href="team-details.html">Hariati Sinaga</a></h3>-->
<!--                            <span class="team-desig">Sekretaris Jenderal</span>-->
<!--                        </div>-->
<!--                        <div class="team-info">-->
<!--                            <span><i class="fal fa-file-check"></i>UI</span>-->
<!--                            <span><i class="fa-light fa-users"></i>Sekjen</span>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
...
<!--                        </div>-->
<!--                        <div class="team-content">-->
<!--                            <h3 class="team-title"><a href="team-details.html">Herdiansyah Hamzah</a></h3>-->
<!--                            <span class="team-desig">Departemen Organisasi</span>-->
<!--                        </div>-->
<!--                        <div class="team-info">-->
<!--                            <span><i class="fal fa-file-check"></i>UNMUL</span>-->
<!--                            <span><i class="fa-light fa-users"></i>PTKO</span>-->
<!--                        </div>-->
<!--                    </div>-->
<!--                </div>-->
<!--            </div>-->
...
Event Area  
==============================-->
<!-- <section class="space overflow-hidden" data-bg-src="assets/img/bg/event-bg_1.png">
    ...
    <div class="container">
        <div class="row">
            <div class="col-lg-6 mb-30 mb-lg-0">
                <div class="cta-card" data-bg-src="assets/img/rtl/cta-bg_3_1.png">
            ...
            <div class="col-lg-6">
                <div class="cta-card" data-bg-src="assets/img/rtl/cta-bg_3_2.png">
                    <div class="title-area mb-40">
                        <span class="sub-title text-white"><i class="fal fa-book me-2"></i>Popular Courses</span>
...
<!--        <img src="https://i.ibb.co.com/twVhTL1r/73-20250404-194334-0000.png" alt="Survei SPK" border="0">-->
<!--        <a href="https://docs.google.com/forms/d/e/1FAIpQLSetJuiy3RVY7UuNJtOZ76e_y7y68z3vi08qjYmIiCTWT6kDtQ/viewform" target="_blank">Isi Survei Sekarang</a>-->
<!--    </div>-->
<!--</div>-->
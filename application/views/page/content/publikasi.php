        ...
        <div class="row gx-30">
            <div class="col-xxl-8 col-lg-7">
                <div class="th-blog blog-single">
                    <div class="blog-img">
                        <img src="assets/img/blog/sejarahcont.png" alt="Blog Image">
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            ...
                            <a href="pengurus"><i class="fa-light fa-book"></i>Publikasi</a>
                        </div>
                        <h2 class="blog-title"><?= $content['publikasi_title']; ?></h2>
                        <p><?= $content['publikasi']; ?></p>
                    </div>

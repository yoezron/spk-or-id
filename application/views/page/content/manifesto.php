        ...
        <div class="row gx-30">
            <div class="col-xxl-8 col-lg-7">
                <div class="th-blog blog-single">
                    <div class="blog-img">
                        <img src="assets/img/blog/manifesto.jpg" alt="Blog Image">
                    </div>
                    <div class="blog-content">
                        <div class="blog-meta">
                            ...
                            <a href="manifesto"><i class="fa-light fa-book"></i>Manifesto SPK</a>
                        </div>
                        <h2 class="blog-title"><?= $content['manif_title']; ?></h2>
                        <p><?= $content['manif_content']; ?></p>
                    </div>

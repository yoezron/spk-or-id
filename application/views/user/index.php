                                ...
                                <div class="card mb-3">
                                    <div class="card-body">
                                        ...
                                        <ul class="nav nav-tabs nav-tabs-custom nav-justified" role="tablist">
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo ($active_tab == 'info') ? 'active' : ''; ?>" data-bs-toggle="tab" href="<?= base_url('user/info'); ?>" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-info-circle"></i></span>
                                                    <span class="d-none d-sm-block">Informasi Anggota</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo ($active_tab == 'userdetail') ? 'active' : ''; ?>" data-bs-toggle="tab" href="<?= base_url('user/userdetail'); ?>" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-clipboard-list"></i></span>
                                                    <span class="d-none d-sm-block">Detail Anggota</span>
                                                </a>
                                            </li>
                                            <li class="nav-item">
                                                <a class="nav-link <?php echo ($active_tab == 'benefit') ? 'active' : ''; ?>" data-bs-toggle="tab" href="<?= base_url('user/benefit'); ?>" role="tab">
                                                    <span class="d-block d-sm-none"><i class="fas fa-user-shield"></i></span>
                                                    <span class="d-none d-sm-block">Manfaat</span>
                                                </a>
                                            </li>
                                        </ul>
                                        ...
                                        <div class="tab-content p-3 text-muted">
                                            <!-- Tab info -->
                                            <div class="tab-pane <?php echo ($active_tab == 'info') ? 'active' : ''; ?>" id="info" role="tabpanel">
                                                <!-- Content tab info -->
                                                <div class="col lg">
                                                    <div class="row">
                                                        <div class="card mb-3">
                                            ...
                                            <!-- Tab userdetail -->
                                            <div class="tab-pane <?php echo ($active_tab == 'userdetail') ? 'active' : ''; ?>" id="userdetail" role="tabpanel">
                                            ...
                                            <!-- Tab benefit -->
                                            <div class="tab-pane <?php echo ($active_tab == 'benefit') ? 'active' : ''; ?>" id="benefit" role="tabpanel">
                                                <!-- Content tab benefit -->
                                                <div class="col lg">
                                                    <div class="row">
